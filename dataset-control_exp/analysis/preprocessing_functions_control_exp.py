...
Control Experiment - Preprocessing pupil dilation
...
class pupilPreprocess(object):
    ...
    def __init__(self, subject, edf, project_directory, eye, msgs, tolkens, sample_rate, tw_blinks, mph, mpd, threshold):
        """Constructor method"""
        ...
        if not os.path.isdir(os.path.join(self.project_directory, self.subject)):
            os.mkdir(os.path.join(self.project_directory, self.subject))
