...
def stop_recording(timestr,task):
    ...
    # sub-xxx_task-ttt_recoding-eyetracking_physio_timestring.EDF 
    new_name = 'sub-'+ original_name[0] +'_task-' + task + '_recording-eyetracking_physio_' + timestr + original_name[1] 
